...
function Calculator() {
  ...
  return (
    <div className=" boxALL">
      <div
        className="inner-border1"
        style={{
          backgroundImage: "url('./MathsBack.jpg')",
        ...
        <div className="box1">
          ...
          <section className="box2">
            <div className="calcu-row">
              <button className="calcu-num" onClick={clear}>
                C
              </button>
              <button className="calcu-num" onClick={deleteNumber}>
                ◀
              </button>
              <button
                className="calcu-num"
            ...
            <div className="calcu-row">
              <button className="calcu-num" onClick={() => appendNumber("7")}>
                7
              </button>
              <button className="calcu-num" onClick={() => appendNumber("8")}>
                8
              </button>
              <button className="calcu-num" onClick={() => appendNumber("9")}>
                9
              </button>
              <button
                className="calcu-num"
            ...
            <div className="calcu-row">
              <button className="calcu-num" onClick={() => appendNumber("4")}>
                4
              </button>
              <button className="calcu-num" onClick={() => appendNumber("5")}>
                5
              </button>
              <button className="calcu-num" onClick={() => appendNumber("6")}>
                6
              </button>
              <button
                className="calcu-num"
            ...
            <div className="calcu-row">
              <button className="calcu-num" onClick={() => appendNumber("1")}>
                1
              </button>
              <button className="calcu-num" onClick={() => appendNumber("2")}>
                2
              </button>
              <button className="calcu-num" onClick={() => appendNumber("3")}>
                3
              </button>
              <button
                className="calcu-num"
            ...
            <div className="calcu-row">
              <button
                className="calcu-num buttonC"
                onClick={() => appendNumber("0")}
              >
                0
              </button>
              <button className="calcu-num" onClick={() => appendNumber(".")}>
                .
              </button>
              <button className="calcu-num" onClick={handleEquals}>
                =
              </button>
            </div>
          </section>
