...
function Animation() {
  ...
  const [running, setRunning] = useState(true);  //ปรับเป็น true ให้ทำงานเลย
  ...
  const [backgroundImage, setBackgroundImage] = useState("url(./IMG/Messi2.jpg)");   //ปรับเป็น Cartoon โชว์  Cartoon
  const [selectedButton, setSelectedButton] = useState('cartoon');    // เก็บสถานะของปุ่มที่ถูกเลือก
  ...
  const changeImage = (type) => {
    const images = {
      ...
      human: "url(./IMG/Beer.jpg)",
      cartoon: "url(./IMG/Messi2.jpg)",
      logo: "url(./IMG/beerpro.png)",
    };
  ...
  return (
    <div id="container">
      ...
      style={{ 
        width: fieldWidth, 
        height: fieldHeight,
        backgroundImage: "url('./backgr11.jpg')",
